                ...
                <div class="product-details-view-content sp-normal-content pt-60">
                    <div class="product-info">
                        ...
                        <div class="product-desc">
                            <p>
                                <span>100% cotton double printed
        ...
        <div class="tab-content">
            <div id="description" class="tab-pane active show" role="tabpanel">
                <div class="product-description">
                    <span>The best is yet to come! Give your walls a
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="li-section-title">
                    <h2>
                        <span>15 other products in the same
                            category:</span>
                    </h2>
                </div>
                <div class="row">
                                ...
                                <div class="product_desc">
                                    <div class="product_desc_info">
                                        <div class="product-review">
                                            <h5 class="manufacturer">
                                                <a href="product-details">Graphic
                                                    Corner</a>
                                            </h5>
                                    ...
                                    <div class="add-actions">
                                        <ul class="add-actions-link">
                                            ...
                                            <li>
                                                <a class="links-details" href="wishlist"><i
                            ...
                            <div class="single-product-wrap">
                                ...
                                <div class="product_desc">
                                    <div class="product_desc_info">
                                        ...
                                        <h4>
                                            <a class="product_name" href="single-product">Mug Today is a good
                                                day</a>
                                        </h4>
                                        <div class="price-box">
