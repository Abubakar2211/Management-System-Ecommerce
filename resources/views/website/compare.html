...
<html class="no-js" lang="zxx">
    ...
    <head>
        ...
        <title>
            Compare || limupa - Digital Products Store eCommerce Bootstrap 4
            Template
        </title>
                        ...
                        <table class="table table-bordered table-hover mb-0">
                            <tbody>
                                ...
                                <tr>
                                    <th>Description</th>
                                    <td>
                                        Impressively thin and light, the HP
                                        Pavilion G6 empowers users to create,
                                        connect, and collaborate, using
                                        enterprise-class performance
                                    </td>
                                    <td>
                                        Impressively thin and light, the HP
                                        ProBook 450 G4 empowers users to create,
                                        connect, and collaborate, using
                                        enterprise-class performance
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div
                                            class="li-pro-rating li-rattingbox"
                                        >
                                            <span
