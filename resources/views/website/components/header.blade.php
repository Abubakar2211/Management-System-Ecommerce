                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4">
                            <div class="header-top-left">
                                <ul class="phone-wrap">
                                    <li>
                                        <span>Telephone Enquiry:</span><a href="#">(+123) 123 321 345</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="setting ht-setting">
                                            <ul class="ht-setting-list">
                                                <li>
                                                    <a href="login-register">My Account</a>
                                                </li>
                                                <li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="logo pb-sm-30 pb-xs-30">
                                <a href="index">
                                    <img src="{{ asset('website/images/menu/logo/1.jpg') }}" alt="" />
                                </a>
                            </div>
                        </div>
                                            ...
                                            <ul class="minicart-product-list">
                                                <li>
                                                    <a href="single-product" class="minicart-product-image">
                                                        <img src="{{ asset('website/images/product/small-size/5.jpg') }}"
                                                            alt="cart products" />
                                                    </a>
                                                    <div class="minicart-product-details">
                                                        <h6>
                                                            <a href="single-product">Aenean eu
                                                                tristique</a>
                                                        </h6>
                                                        <span>£40 x 1</span>
                                                    </div>
                                                ...
                                                <li>
                                                    <a href="single-product" class="minicart-product-image">
                                                        <img src="{{ asset('website/images/product/small-size/6.jpg') }}"
                                                            alt="cart products" />
                                                    </a>
                                                    <div class="minicart-product-details">
                                                        <h6>
                            ...
                            <div class="hb-menu">
                                <nav>
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{route('product-details')}}">Single Product</a>
                                        </li>
                                        <li>
                                            <a href="{{route('shopping-cart')}}">Shopping Cart</a>
                                        </li>
                                        <li>
                                            <a href="{{route('blog-details')}}">Blog Detail</a>
                                        </li>
                                        <li>
