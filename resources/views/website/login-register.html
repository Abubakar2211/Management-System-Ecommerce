...
<html class="no-js" lang="zxx">
    ...
    <head>
        ...
        <title>
            Login Register || limupa - Digital Products Store eCommerce
        ...
        <div class="body-wrapper">
            ...
            <div class="page-section mb-60">
                <div class="container">
                    <div class="row">
                        <div
                            class="col-sm-12 col-md-12 col-xs-12 col-lg-6 mb-30"
                        >
                            <!-- Login Form s-->
                            <form action="#">
                                <div class="login-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div
                                                class="check-box d-inline-block ml-0 ml-md-2 mt-10"
                                            >
                                                <input
                                                    type="checkbox"
                                                    id="remember_me"
                                        ...
                                        <div
                                            class="col-md-4 mt-10 mb-20 text-left text-md-right"
                                        >
