...
<html class="no-js" lang="zxx">
    ...
    <head>
        ...
        <title>
            Shop Right Sidebar || limupa - Digital Products Store eCommerce
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-9 order-2 order-lg-1 order-sm-1">
                            ...
                            <div class="shop-top-bar mt-30">
                                <div class="shop-bar-inner">
                                    <div class="product-view-mode">
                                        ...
                                        <ul
                                            class="nav shop-item-filter-list"
                                            role="tablist"
                                        >
                                            <li
                                                class="active"
                            ...
                            <div class="shop-products-wrapper">
                                <div class="tab-content">
                                    ...
                                    >
                                        <div
                                            class="product-area shop-product-area"
                                        >
                                            <div class="row">
                                                <div
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                >
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div
                                                            class="shop-add-action mb-xs-30"
                                                        >
                                                            <ul
                                                                class="add-actions-link"
                                                            >
                                                ...
                                                <div
                                                    class="row product-layout-list last-child"
                                                >
                                                    <div
                                                        class="col-lg-3 col-md-5"
                                                    >
                                    ...
                                    <div class="paginatoin-area">
                                        <div class="row">
                                            <div
                                                class="col-lg-6 col-md-6 pt-xs-15"
                                            >
                                                <p>
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <ul
                                                    class="pagination-box pt-xs-20 pb-xs-15"
                                                >
                                                    <li>
                                                        <a
                                                            href="#"
                        ...
                        <div class="col-lg-3 order-1 order-lg-2">
                            ...
                            <div
                                class="sidebar-categores-box mt-sm-30 mt-xs-30"
                            >
                            ...
                            <div class="sidebar-categores-box">
                                ...
                                <!-- filter-sub-area start -->
                                <div
                                    class="filter-sub-area pt-sm-10 pb-sm-15 pb-xs-15"
                                >
